...
const LocHumanArrivals = ({ navigation }) => {
  ...
  //converts the continent to year early humans arrived
  ...
  //this gets the continent from the location that the user provides and converts it to years
  ...
  //this adds permissions to the project and gets the location if permitted
  useEffect(() => {
    (async () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Adds in the response based on the data provided*/}
